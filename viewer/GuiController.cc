...
GuiController::GuiController(const TGWindow *p, int w, int h, const char* fn, const char* tpc, const char* frame, int rebin)
{
    ...
    data = new Data(filename.Data(), tpc, frame, rebin);
